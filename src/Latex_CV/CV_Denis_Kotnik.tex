...
\photo[110pt][0.4pt]{pictures/jaz} % The first bracket is the picture height, the second is the thickness of the frame around the picture (0pt for no frame)
...
\cvlistdoubleitem{Računalništvo}{Borilne veščine (Wing Chun)}
\cvlistdoubleitem{Igranje kitare}{Petje (v zboru)}
\cvlistdoubleitem{Tek}{Šah}
...
\cvlistdoubleitem{Včasih len}{Čut za skrb, odgovornost}
\cvlistdoubleitem{Všeč mi je red in čistoča}{Všeč so mi osebni izzivi}
\cvlistdoubleitem{Organiziran}{}
\cvlistdoubleitem{Ni mi všeč večinsko, težim k unikatnemu mišljenju}{}
