...
\address{Jezero 3A, 8210 Trebnje}{Slovenija}% optional, remove / comment the line if not wanted; the "postcode city" and and "country" arguments can be omitted or provided empty
\phone[mobile]{041-628-416}                   % optional, remove / comment the line if not wanted
%\phone[fixed]{+2~(345)~678~901}                    % optional, remove / comment the line if not wanted
%\phone[fax]{+3~(456)~789~012}                      % optional, remove / comment the line if not wanted
\email{denis.kotnik@gmail.com}                               % optional, remove / comment the line if not wanted
\homepage{www.kotnik.si}                         % optional, remove / comment the line if not wanted
...
%-----       letter       ---------------------------------------------------------
% recipient data
\recipient{Krka, d.d., Novo mesto}{Kadrovska služba \\ Šmarješka cesta 6 \\ 8501 Novo mesto}
\date{\today}
\opening{Spoštovani,}
\closing{S spoštovanjem,}
\enclosure[Priloga]{življenjepis}          % use an optional argument to use a string other than "Enclosure", or redefine \enclname
\makelettertitle
