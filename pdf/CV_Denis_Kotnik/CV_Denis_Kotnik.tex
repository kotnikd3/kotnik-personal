...
\cvitem{Opis}{
Svoj delež na oddelku Okolje prispevam predvsem z razvojem in vzdrževanjem infrastrukture cestnovremenskih postaj Družbe za avtoceste v Republiki Sloveniji (DARS), Direkcije Republike Slovenije za infrastrukturo (DRSI) in nekaterih slovenskih občin.
\newline
\newline
