...
\cvitem{Trajanje}{17.\ februar 2014\textendash danes}
\cvitem{Opis}{
Od februarja 2014 se v podjetju CGS Labs na oddelku Okolje ukvarjam z razvijanjem in vzdrževanjem (angl. DevOps) cestnovremenskih informacijskih sistemov predvsem za Družbo za avtoceste v Republiki Sloveniji (DARS), Direkcijo Republike Slovenije za infrastrukturo (DRSI) in nekatere slovenske občine.
\newline
Razvijam predvsem v programskih jezikih Java in Python ter okoljih Laravel (PHP) in Microsoft .NET (C\#, ASP.NET Web Forms, sistemske storitve in konzolne aplikacije za Windows). Vzdržujem cestnovremenske postaje po Sloveniji, podatkovne baze (Microsoft SQL Server, MySQL) ter strežnike (Windows 2012 R2, Cent OS, Debian Squeeze).
}
\cvitem{}{}
...
\cvitem{2017}{Front-End Web UI Frameworkds and  Tools, \textit{www.coursera.org}}
